...
describe("POST /sign-up", ()=>{
    ...
    it("Should return 201 when create user",
    signUpControllerTest.createUser);
});

describe("POST /sign-in", () =>{
    it("should answer with status 200 when given valid credentials",
    signInControllerTest.login
    );

    it("should return 409 when the email is incorrect",
...
describe("POST /app/adicionar-prova", ()=>{
     ...
     it("should return 201 when create test",
     testControllerTest.createTest
     );

    it("returns 422 given invalid body", 
    testControllerTest.invalidBody
    ); 
});

describe ("GET /categories", ()=>{

    it("returns 401 given invalid token",
categoriesControllerTest.invalidToken);

it("returns 200 given valid token", 
categoriesControllerTest.valid
);
});
...
describe ("GET /disciplines", ()=>{
    ...
    it("returns 401 given invalid token",
disciplinesControllerTest.invalidToken);


it("returns 200 given valid token", 
disciplinesControllerTest.valid
);
});
...
describe ("GET /teachers", ()=>{
    ...
    it("returns 401 given invalid token",
teacherControllerTest.invalidToken);


it("returns 200 given valid token", 
teacherControllerTest.valid
);
});
...
describe ("GET /tests", ()=>{
    ...
    it("returns 401 given invalid token",
testControllerTest.invalidToken);

it("returns 400 given invalid body", 
testControllerTest.invalidBodyGet
);

it("returns 400 given invalid groupBy",
testControllerTest.invalidGroup
);

it("returns 200 given valid token", 
testControllerTest.getTest
);
});

describe("PATCH /tests/:id", ()=> {

    it("returns 200 given valid testId", 
    testControllerTest.validId
    );

    it("returns 401 given invalid token", 
    testControllerTest.invalidTokenPatch
    );
